...
carriers.sidebandCarrierPixels.ksPlus = ksPlus;
carriers.sidebandCarrierPixels.ksMinus = ksMinus;
carriers.sidebandCarrierPixels.ktPlus = ktPlus;
carriers.sidebandCarrierPixels.ktMinus = ktMinus;
...
carriers.sidebandPeakStrengths.SPlus = ratioSPlus;
carriers.sidebandPeakStrengths.SMinus = ratioSMinus;
carriers.sidebandPeakStrengths.TPlus = ratioTPlus;
carriers.sidebandPeakStrengths.TMinus = ratioTMinus;
...
diagnostics.sidebandCarrierPixels = carriers.sidebandCarrierPixels;
diagnostics.sidebandPeakStrengths = carriers.sidebandPeakStrengths;
diagnostics.coarsePairResidualS = norm(ksPlus + ksMinus);
diagnostics.coarsePairResidualT = norm(ktPlus + ktMinus);
