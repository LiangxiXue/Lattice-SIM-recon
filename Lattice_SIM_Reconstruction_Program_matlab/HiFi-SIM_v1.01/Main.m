...
javaaddpath 'D:\Program Files\MATLAB\R2014a\java\mij.jar';  % Note to replace the installation path
javaaddpath 'D:\Program Files\MATLAB\R2014a\java\ij.jar';   % Note to replace the installation path
MIJ.start;
